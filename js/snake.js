...
function gameOver() {
    ...
    if (firstgame) {
        document.getElementById("gameovermsg").innerHTML = "ESCOLHA A DIFICULDADE";
    }
    else {
        document.getElementById("gameovermsg").innerHTML = "SCORE: " + score;
    }  
